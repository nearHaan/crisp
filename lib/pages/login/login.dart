import 'package:crisp/controllers/main_controller.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    void onClick(){
      controller.onLogin(phnoController.text, passController.text);
    }
    return SafeArea(
      child: Scaffold(
                    ...
                    child: Column(
                      children: [
                        ...
                        CustomTextInput(
                          ...
                          icon: Icons.password,
                          isPassword: true,
                          hideText: controller.hidePass,
                          onEyeClick: controller.onEyeToggle,
                        ),
                        SizedBox(height: 10,),
                        ForgotPassBox(),
                        SizedBox(height: 30,),
                        Row(
                          children: [
                            Expanded(
                              child: LoginBtn(onClick: onClick,),
                            ),
                          ],
                        ),
                        SizedBox(height: 20,),
